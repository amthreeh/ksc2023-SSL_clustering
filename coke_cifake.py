...
Original file is located at
    https://colab.research.google.com/drive/15PXaMh1Xxsu7V9_EjAOElwC072OVxkFW
"""
...
class CoKe(nn.Module):
    ...
    def __init__(self, base_encoder, K, dim=128, num_ins=50000, num_head=10, T=0.1, dual_lr=20, stage=20, t=0.5,
                 ratio=0.4, ls=5):
...
def save_checkpoint(state, filename='checkpoint.pth.tar'):
    if (state['epoch'] - 1) % 100 != 0 or state['epoch'] == 1:
        return
