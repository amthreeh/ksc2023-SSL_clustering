...
Original file is located at
    https://colab.research.google.com/drive/1Yw8K_54gLFPUsAj1sHysdnBllWAIUe97
"""
...
args = easydict.EasyDict({
    ...
    "p" : 100,
    "print_freq": 100,
    "resume": '', #model/cc_cif_s180_0180.pth.tar
    "log": 'cc_cif_true',
    "coke_dim": 10,
    "coke_num_ins" : 50000,
    "coke_num_head": 10,
...
class CoKe(nn.Module):
    ...
    def forward(self, img, target, epoch):
        ...
        # # PCA를 사용하여 차원 축소 후 시각화하기 위한 데이터 준비
        # pca = PCA(n_components=2)
        # pca_result = pca.fit_transform(x_normalized.cpu().detach().numpy())

        # # 시각화 (scatter plot)
        # plt.figure(figsize=(6,6))
        # data = np.column_stack((pca_result[:, 0], pca_result[:, 1]))
        # sns.kdeplot(data)
        # plt.xlabel('Component 1')
        # plt.ylabel('Component 2')
        # plt.title('Distribution Plot')
        # plt.savefig("cc_distribution/distribution.png")
...
def main_worker(args):
    ...
    root="/data/dhk/cifake/train/REAL/"
